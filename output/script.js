document.addEventListener('DOMContentLoaded', () => {
    ...
    const videos = [
  {title:{de:"Erstellung von Montagedecken - Rigips Verarbeitungsanleitung Trockenbau",en:"Erstellung von Montagedecken - Rigips Verarbeitungsanleitung Trockenbau"},description:{de:"Rigips Anleitung: Schritt für Schritt zur perfekten Montagedecke im Trockenbau. Tipps & Tricks vom Profi!",en:"Rigips guide: Step-by-step to the perfect suspended ceiling in drywall construction. Tips & tricks from the pro!"},rating:5.0,views:"1.6M",category:"grundlagen",youtubeId:"obvKgvIv_Vg",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung von Türöffnungen - Rigips Verarbeitungsanleitung Trockenbau",en:"Erstellung von Türöffnungen - Rigips Verarbeitungsanleitung Trockenbau"},description:{de:"Rigips Anleitung: Türöffnungen im Trockenbau professionell erstellen. Alle Details und Kniffe für den perfekten Einbau.",en:"Rigips guide: Professionally create door openings in drywall construction. All the details and tricks for perfect installation."},rating:5.0,views:"1.6M",category:"tueren",youtubeId:"uoU_BlY_2Lw",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung von Vorsatzschalen mit Unterkonstruktion - Rigips Verarbeitungsanleitung Trockenbau",en:"Erstellung von Vorsatzschalen mit Unterkonstruktion - Rigips Verarbeitungsanleitung Trockenbau"},description:{de:"Rigips Anleitung: So baust du Vorsatzschalen mit Unterkonstruktion im Trockenbau. Verständlich erklärt & einfach umsetzen!",en:"Rigips guide: How to build furring strips with substructure in drywall construction. Clearly explained & easy to implement!"},rating:5.0,views:"1.5M",category:"grundlagen",youtubeId:"i7jZ9suB9y8",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2",en:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2"},description:{de:"Knauf Tutorial: Errichte die perfekte Unterkonstruktion für deine Trockenbauwand! Teil 2 unserer Ständerwand-Serie.",en:"Knauf tutorial: Build the perfect substructure for your drywall! Part 2 of our stud wall series."},rating:5.0,views:"536K",category:"waende",youtubeId:"ihp8HXwQDl8",channel:"Knauf GmbH Österreich"},
  {title:{de:"Trennwand einbauen | Schritt-für-Schritt-Anleitung",en:"Trennwand einbauen | Schritt-für-Schritt-Anleitung"},description:{de:"HELLWEG zeigt: Trennwand einbauen leicht gemacht! Schritt-für-Schritt-Anleitung für Heimwerker.",en:"HELLWEG shows: Installing a partition wall made easy! Step-by-step instructions for DIY enthusiasts."},rating:5.0,views:"535K",category:"waende",youtubeId:"CuWG8cjPxpE",channel:"HELLWEG Baumarkt"},
  {title:{de:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau",en:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau"},description:{de:"Knauf Profi-Tipps: Perfekt Verspachteln ohne Fehler! So gelingt dir die ideale Oberfläche im Trockenbau.",en:"Knauf professional tips: Perfect filling without mistakes! This is how you achieve the ideal surface in drywall construction."},rating:5.0,views:"433K",category:"spachteln",youtubeId:"ZrHqNdZzCw0",channel:"Knauf GmbH Österreich"},
  {title:{de:"Gipskarton spachteln und schleifen | OBI",en:"Gipskarton spachteln und schleifen | OBI"},description:{de:"OBI Anleitung: Gipskarton spachteln und schleifen wie ein Profi. Für glatte Wände und perfekte Ergebnisse.",en:"OBI guide: Filling and sanding plasterboard like a pro. For smooth walls and perfect results."},rating:5.0,views:"328K",category:"spachteln",youtubeId:"tMMnkflnZWY",channel:"OBI Baumarkt"},
  {title:{de:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI",en:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI"},description:{de:"OBI Tutorial: Doppelbeplankte Trockenbauwand mit Tür einbauen und dämmen. Alles, was du wissen musst!",en:"OBI tutorial: Install and insulate a double-planked drywall with a door. Everything you need to know!"},rating:5.0,views:"275K",category:"werkzeuge",youtubeId:"NlOS-hPiubc",channel:"OBI Baumarkt"},
  {title:{de:"Beplanken mit Gipsplatten | Trockenbauwand bauen - Teil 3",en:"Beplanken mit Gipsplatten | Trockenbauwand bauen - Teil 3"},description:{de:"Knauf Anleitung: Gipsplatten richtig beplanken. Teil 3 unserer Serie zum Bau einer Trockenbauwand.",en:"Knauf guide: Properly planking with gypsum boards. Part 3 of our series on building a drywall."},rating:5.0,views:"255K",category:"waende",youtubeId:"Sq_y8rqNYjs",channel:"Knauf GmbH Österreich"},
  {title:{de:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI",en:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI"},description:{de:"OBI Schweiz: Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen. Schweizer Anleitung für dein Projekt.",en:"OBI Switzerland: Build and insulate a double-planked drywall with a door. Swiss instructions for your project."},rating:4.8,views:"5K",category:"waende",youtubeId:"KxZYO-KoTCc",channel:"OBI Schweiz"}
];
