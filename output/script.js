document.addEventListener('DOMContentLoaded', () => {
    // KURATIERTE Videos vom DIY Video Finder (30. March 2026)
...
1:23 Planung
1:56 Erstellung d"},rating:5.0,views:"866K",category:"waende",youtubeId:"-1gU2JrwAqo",channel:"BAUHAUS"},
...
Bei Min. 1:27 hat sich ein Fehler eingeschlichen, die dort angegebenen Maße sind falsch, richtig ist:
625 mm + 2.000 mm (Standardmaß) oder
6"},rating:5.0,views:"621K",category:"grundlagen",youtubeId:"AHTM1fYmvB4",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Trennwand einbauen | Schritt-für-Schritt-Anleitung",en:"Trennwand einbauen | Schritt-für-Schritt-Anleitung"},description:{de:"Wir zeigen Schritt für Schritt, wie Sie eine Trennwand errichten. Die benötigten Materialien finden Sie in Ihrem HELLWEG-Markt oder unter http://bit.l",en:"Wir zeigen Schritt für Schritt, wie Sie eine Trennwand errichten. Die benötigten Materialien finden Sie in Ihrem HELLWEG-Markt oder unter http://bit.l"},rating:5.0,views:"541K",category:"waende",youtubeId:"CuWG8cjPxpE",channel:"HELLWEG Baumarkt"},
  {title:{de:"Zarge und Innentür einbauen | OBI",en:"Zarge und Innentür einbauen | OBI"},description:{de:"Eine gut verbaute Zarge hält nicht nur Türen im Lot, gemeinsam dichten die beiden Komponenten einen Raum auch vielschichtig ab. Das schafft Privatsphä",en:"Eine gut verbaute Zarge hält nicht nur Türen im Lot, gemeinsam dichten die beiden Komponenten einen Raum auch vielschichtig ab. Das schafft Privatsphä"},rating:5.0,views:"351K",category:"werkzeuge",youtubeId:"pjrMg8-DIAM",channel:"OBI Baumarkt"},
  {title:{de:"Metallprofile & Schrauben für den Trockenbau | Trockenbau Wissen",en:"Metallprofile & Schrauben für den Trockenbau | Trockenbau Wissen"},description:{de:"Für die Konstruktion von Trockenbauwänden kommen unterschiedliche Profile und Schrauben zum Einsatz. In diesem Video erfährst du, was der Unterschied ",en:"Für die Konstruktion von Trockenbauwänden kommen unterschiedliche Profile und Schrauben zum Einsatz. In diesem Video erfährst du, was der Unterschied "},rating:5.0,views:"152K",category:"werkzeuge",youtubeId:"e9ghcbP200g",channel:"Knauf GmbH Österreich"},
  {title:{de:"Trockenbauwand mit Nische richtig bauen | toom Werkstatt",en:"Trockenbauwand mit Nische richtig bauen | toom Werkstatt"},description:{de:"Nischen in einer Trockenbauwand sind tolle Gestaltungselemente um z.B. den Fernseher oder Dekolampen in die Wand zu integrieren. Was du als Selbermach",en:"Nischen in einer Trockenbauwand sind tolle Gestaltungselemente um z.B. den Fernseher oder Dekolampen in die Wand zu integrieren. Was du als Selbermach"},rating:4.8,views:"8K",category:"waende",youtubeId:"gnjLVlfSirs",channel:"toom Baumarkt"},
  {title:{de:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI",en:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI"},description:{de:"Mit Gipskartonplatten kannst du ohne grossen Arbeitsaufwand oder Vorkenntnisse flexibel Räume aufteilen, um so den Grundriss deines Zuhauses zu veränd",en:"Mit Gipskartonplatten kannst du ohne grossen Arbeitsaufwand oder Vorkenntnisse flexibel Räume aufteilen, um so den Grundriss deines Zuhauses zu veränd"},rating:4.8,views:"8K",category:"waende",youtubeId:"KxZYO-KoTCc",channel:"OBI Schweiz"},
