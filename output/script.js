document.addEventListener('DOMContentLoaded', () => {
    ...
    const videos = [
  {title:{de:"Erstellung von Montagedecken - Rigips Verarbeitungsanleitung Trockenbau",en:"Erstellung von Montagedecken - Rigips Verarbeitungsanleitung Trockenbau"},description:{de:"Montagedecken im Trockenbau: Rigips zeigt, wie's geht! Schritt-für-Schritt Anleitung für perfekte Ergebnisse.",en:"Suspended ceilings with Rigips: Step-by-step guide for perfect results."},rating:5.0,views:"1.6M",category:"grundlagen",youtubeId:"obvKgvIv_Vg",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung von Vorsatzschalen mit Unterkonstruktion - Rigips Verarbeitungsanleitung Trockenbau",en:"Erstellung von Vorsatzschalen mit Unterkonstruktion - Rigips Verarbeitungsanleitung Trockenbau"},description:{de:"Vorsatzschalen mit Unterkonstruktion: Rigips erklärt den Aufbau im Detail. Ideal für Schall- und Wärmedämmung.",en:"Wall linings with substructure: Rigips explains the construction in detail. Ideal for sound and heat insulation."},rating:5.0,views:"1.5M",category:"grundlagen",youtubeId:"i7jZ9suB9y8",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung/Aufbau von Holzständerwänden, Rigidur Gipsfaserplatten - Rigips Verarbeitung Trockenbau",en:"Erstellung/Aufbau von Holzständerwänden, Rigidur Gipsfaserplatten - Rigips Verarbeitung Trockenbau"},description:{de:"Holzständerwände mit Rigidur: Bauanleitung für stabile und hochwertige Wände im Trockenbau von Rigips.",en:"Timber frame walls with Rigidur: Construction guide for stable and high-quality walls in drywall construction by Rigips."},rating:5.0,views:"910K",category:"grundlagen",youtubeId:"kyfTjpbcr_g",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2",en:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2"},description:{de:"Trockenbauwand errichten, Teil 2: Die Unterkonstruktion. Knauf zeigt den Aufbau einer Ständerwand im Detail.",en:"Drywall construction, part 2: The substructure. Knauf shows the construction of a stud wall in detail."},rating:5.0,views:"536K",category:"waende",youtubeId:"ihp8HXwQDl8",channel:"Knauf GmbH Österreich"},
  {title:{de:"Trennwand einbauen | Schritt-für-Schritt-Anleitung",en:"Trennwand einbauen | Schritt-für-Schritt-Anleitung"},description:{de:"Trennwand einbauen leicht gemacht! HELLWEG zeigt Schritt für Schritt, wie du eine Trennwand im Trockenbau errichtest.",en:"Installing a partition wall made easy! HELLWEG shows step by step how to build a partition wall in drywall construction."},rating:5.0,views:"535K",category:"waende",youtubeId:"CuWG8cjPxpE",channel:"HELLWEG Baumarkt"},
  {title:{de:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau",en:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau"},description:{de:"Perfekt Verspachteln im Trockenbau: Knauf zeigt die häufigsten Fehler und wie man sie vermeidet. Profi-Tipps für glatte Wände!",en:"Perfect filling in drywall construction: Knauf shows the most common mistakes and how to avoid them. Professional tips for smooth walls!"},rating:5.0,views:"433K",category:"spachteln",youtubeId:"ZrHqNdZzCw0",channel:"Knauf GmbH Österreich"},
  {title:{de:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI",en:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI"},description:{de:"Doppelbeplankte Trockenbauwand mit Tür: OBI zeigt, wie du eine Wand mit Tür baust und optimal dämmst.",en:"Double-planked drywall with door: OBI shows how to build a wall with a door and insulate it optimally."},rating:5.0,views:"275K",category:"werkzeuge",youtubeId:"NlOS-hPiubc",channel:"OBI Baumarkt"},
  {title:{de:"Beplanken mit Gipsplatten | Trockenbauwand bauen - Teil 3",en:"Beplanken mit Gipsplatten | Trockenbauwand bauen - Teil 3"},description:{de:"Trockenbauwand beplanken, Teil 3: Knauf zeigt die richtige Technik für die Beplankung mit Gipsplatten.",en:"Planking drywall, part 3: Knauf shows the correct technique for planking with gypsum boards."},rating:5.0,views:"255K",category:"waende",youtubeId:"Sq_y8rqNYjs",channel:"Knauf GmbH Österreich"},
  {title:{de:"Metallprofile & Schrauben für den Trockenbau | Trockenbau Wissen",en:"Metallprofile & Schrauben für den Trockenbau | Trockenbau Wissen"},description:{de:"Metallprofile & Schrauben im Trockenbau: Knauf erklärt die wichtigsten Materialien und ihre Anwendung im Trockenbau.",en:"Metal profiles & screws in drywall construction: Knauf explains the most important materials and their application in drywall construction."},rating:5.0,views:"149K",category:"werkzeuge",youtubeId:"e9ghcbP200g",channel:"Knauf GmbH Österreich"},
  {title:{de:"Decke abhängen | Trockenbauguide | Deckensystem | Trockenbau -#Trockenbau #Decke #Spachteln",en:"Decke abhängen | Trockenbauguide | Deckensystem | Trockenbau -#Trockenbau #Decke #Spachteln"},description:{de:"Decke abhängen im Trockenbau: Siniat zeigt, wie du ein Deckensystem installierst und verspachtelst. Schritt-für-Schritt Anleitung.",en:"Suspended ceiling in drywall construction: Siniat shows how to install and fill a ceiling system. Step-by-step instructions."},rating:5.0,views:"130K",category:"decken",youtubeId:"DpEXwahrqSE",channel:"Siniat by Etex | Innovativer Trockenbau"}
];
