document.addEventListener('DOMContentLoaded', () => {
    // KURATIERTE Videos vom DIY Video Finder (29. June 2026)
...
6"},rating:5.0,views:"624K",category:"grundlagen",youtubeId:"AHTM1fYmvB4",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2",en:"Unterkonstruktion einer Ständerwand errichten | Trockenbauwand bauen - Teil 2"},description:{de:"In dieser Episode von "So geht Trockenbau" Serie lernst du, wie du für deine selbstgebaute Trockenbauwand das Ständerwerk mit Tür aufstellst. Die Unte",en:"In dieser Episode von "So geht Trockenbau" Serie lernst du, wie du für deine selbstgebaute Trockenbauwand das Ständerwerk mit Tür aufstellst. Die Unte"},rating:5.0,views:"567K",category:"waende",youtubeId:"ihp8HXwQDl8",channel:"Knauf GmbH Österreich"},
  {title:{de:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau",en:"Perfekt Verspachteln: So machst du keine Fehler - So geht Trockenbau"},description:{de:"Willst du spachteln wie ein echter Meisterspachtler? Unser Vorfürmeister Adi ist unser Mann wenns ums Verspachteln von Trockenbauwänden geht. In diese",en:"Willst du spachteln wie ein echter Meisterspachtler? Unser Vorfürmeister Adi ist unser Mann wenns ums Verspachteln von Trockenbauwänden geht. In diese"},rating:5.0,views:"467K",category:"spachteln",youtubeId:"ZrHqNdZzCw0",channel:"Knauf GmbH Österreich"},
  {title:{de:"Bilder, Schrank, Regal und Fernseher an Trockenbauwand montieren (Anleitung)",en:"Bilder, Schrank, Regal und Fernseher an Trockenbauwand montieren (Anleitung)"},description:{de:"Dass man keine schweren Lasten auf eine Trockenbauwand montieren kann ist ein Mythos! Wir zeigen dir in diesem Video wie du Bilder, Boards, Kästen ode",en:"Dass man keine schweren Lasten auf eine Trockenbauwand montieren kann ist ein Mythos! Wir zeigen dir in diesem Video wie du Bilder, Boards, Kästen ode"},rating:5.0,views:"327K",category:"waende",youtubeId:"-hdH2xctAYg",channel:"Knauf GmbH Österreich"},
  {title:{de:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI",en:"Doppelbeplankte Trockenbauwand mit Tür bauen und dämmen | OBI"},description:{de:"Mit Gipskartonplatten kannst du ohne großen Arbeitsaufwand oder Vorkenntnisse flexibel Räume aufteilen, um so den Grundriss deines Zuhauses zu verände",en:"Mit Gipskartonplatten kannst du ohne großen Arbeitsaufwand oder Vorkenntnisse flexibel Räume aufteilen, um so den Grundriss deines Zuhauses zu verände"},rating:5.0,views:"305K",category:"werkzeuge",youtubeId:"NlOS-hPiubc",channel:"OBI Baumarkt"},
  {title:{de:"Decke abhängen: Spachteln - Teil 2 | OBI",en:"Decke abhängen: Spachteln - Teil 2 | OBI"},description:{de:"Hast du bereits eine Unterkonstruktion gebaut, um deine Decke abzuhängen, geht es nun ans Anbringen von Rigipsplatten. Diese verschraubst du mit der U",en:"Hast du bereits eine Unterkonstruktion gebaut, um deine Decke abzuhängen, geht es nun ans Anbringen von Rigipsplatten. Diese verschraubst du mit der U"},rating:4.8,views:"28K",category:"spachteln",youtubeId:"MbkNHkXhZlY",channel:"OBI Baumarkt"},
  {title:{de:"Drei schlimme FEHLER beim Trockenbau - und wie man sie vermeiden kann",en:"Drei schlimme FEHLER beim Trockenbau - und wie man sie vermeiden kann"},description:{de:"Leider schon häufig gesehen. Es gibt drei große Fehler, die man beim Trockenbau machen kann und welche schlimme Folgen mit sich bringen, die sich erst",en:"Leider schon häufig gesehen. Es gibt drei große Fehler, die man beim Trockenbau machen kann und welche schlimme Folgen mit sich bringen, die sich erst"},rating:4.0,views:"816K",category:"waende",youtubeId:"ILUF74CsSf8",channel:"Der Wandprofi - Andreas Neufeld"},
...
Immer w"},rating:4.0,views:"373K",category:"waende",youtubeId:"1ofu_1cv0eA",channel:"diybook"}
];
