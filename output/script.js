document.addEventListener('DOMContentLoaded', () => {
    ...
    const videos = [
  {title:{de:"Wand einziehen | HORNBACH Meisterschmiede",en:"Building a Wall | HORNBACH Master Workshop"},description:{de:"Professionelle Anleitung zum Errichten einer Trockenbauwand mit Metallständerwerk.",en:"Professional guide to building a drywall partition with metal studs."},rating:5.0,views:"1.2M",category:"vorwand",youtubeId:"mwEnTFm80-M",channel:"HORNBACH"},
  {title:{de:"Erstellung von Montagedecken - Rigips",en:"Creating Suspended Ceilings - Rigips"},description:{de:"Offizielle RIGIPS Anleitung für abgehängte Decken nach DIN 18181.",en:"Official RIGIPS guide for suspended ceilings according to DIN 18181."},rating:5.0,views:"890K",category:"decke",youtubeId:"obvKgvIv_Vg",channel:"SAINT-GOBAIN RIGIPS"},
  {title:{de:"Erstellung von Türöffnungen - Rigips",en:"Creating Door Openings - Rigips"},description:{de:"Türzargen und Öffnungen in Trockenbauwänden fachgerecht erstellen.",en:"How to properly create door frames and openings in drywall."},rating:5.0,views:"650K",category:"tueren",youtubeId:"uoU_BlY_2Lw",channel:"SAINT-GOBAIN RIGIPS"},
  {title:{de:"Vorsatzschalen mit Unterkonstruktion - Rigips",en:"Furring Strips with Substructure - Rigips"},description:{de:"Vorsatzschalen zur Wandverkleidung mit CW/UW-Profilen nach DIN.",en:"Wall cladding with furring strips using CW/UW profiles per DIN standards."},rating:5.0,views:"720K",category:"vorwand",youtubeId:"i7jZ9suB9y8",channel:"SAINT-GOBAIN RIGIPS"}
];
