document.addEventListener('DOMContentLoaded', () => {
    ...
    const videos = [
  {title:{de:"Wand einziehen | HORNBACH Meisterschmiede",en:"Building a Wall | HORNBACH Master Workshop"},description:{de:"Professionelles Video von HORNBACH über die korrekte Technik für Trennwände und Unterkonstruktionen.",en:"Professional video from HORNBACH about the correct technique for partition walls and frameworks."},rating:5.0,views:"1M",category:"vorwand",youtubeId:"mwEnTFm80-M",channel:"HORNBACH"},
  {title:{de:"Erstellung von Vorsatzschalen mit Unterkonstruktion - Rigips",en:"Creating Additional Panels with Framework - Rigips"},description:{de:"Gutes Video von RIGIPS zur Erstellung von Vorsatzschalen mit wertvollen Informationen.",en:"Good video from RIGIPS on creating additional panels with valuable information."},rating:5.0,views:"1M",category:"vorwand",youtubeId:"i7jZ9suB9y8",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung von Montagedecken - Rigips Verarbeitungsanleitung",en:"Creating Suspended Ceilings - Rigips Processing Instructions"},description:{de:"Qualitativ hochwertiges Video von RIGIPS über die Grundlagen für Montagedecken.",en:"High-quality video from RIGIPS about the basics of suspended ceilings."},rating:5.0,views:"1M",category:"decke",youtubeId:"obvKgvIv_Vg",channel:"SAINT-GOBAIN RIGIPS GmbH"},
  {title:{de:"Erstellung von Türöffnungen - Rigips Verarbeitungsanleitung",en:"Creating Door Openings - Rigips Processing Instructions"},description:{de:"Wertvolles Video von RIGIPS zur fachlich korrekten Erstellung von Türöffnungen.",en:"Valuable video from RIGIPS on the technically correct creation of door openings."},rating:5.0,views:"1M",category:"tueren",youtubeId:"uoU_BlY_2Lw",channel:"SAINT-GOBAIN RIGIPS GmbH"},
];
